...
{
    const char* pszTimestamp = "A Genius was born on 07th of July in 1996 in Herrenberg/Germany.";
    const CScript genesisOutputScript = CScript() << ParseHex("316984710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 3504000;
        ...
        genesis = CreateGenesisBlock(1621964007, 2000566415, 0x1e0ffff0, 1, 6931 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xccb263802acbef345470f33845a428a4ebe1c603ccbe7d2cf56f9544239de7a7 "));
        assert(genesis.hashMerkleRoot == uint256S("0x1c916f2680251b690650c474fdcb68ee16a540f49c1818e51f383a1f3c14ca74"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("80.240.21.50", "node1.diamint.org", true));
        vSeeds.push_back(CDNSSeedData("137.220.55.170", "node2.diamint.org", true));
        //vSeeds.push_back(CDNSSeedData("diaminttools.com", "dnsseed.diaminttools.com"));
        //vSeeds.push_back(CDNSSeedData("diamintpool.org", "dnsseed.diamintpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xccb263802acbef345470f33845a428a4ebe1c603ccbe7d2cf56f9544239de7a7 "))
        ...
        chainTxData = ChainTxData{
            ...
            1621964007, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1621964007, 2725565, 0x1e0ffff0, 1, 6931 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x9ff911c77a4137b7dd5bd20cbfdfd1511ab927f84f0f49597a90e3b4f41aad06 "));
        assert(genesis.hashMerkleRoot == uint256S("0x1c916f2680251b690650c474fdcb68ee16a540f49c1818e51f383a1f3c14ca74"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x9ff911c77a4137b7dd5bd20cbfdfd1511ab927f84f0f49597a90e3b4f41aad06 ")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1621964007, 0, 0x207fffff, 1, 6931 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xabe33fee4a90bcb6988686fa85fe20f63e4af427a0038335b737f31055fad9b5 "));
        assert(genesis.hashMerkleRoot == uint256S("0x1c916f2680251b690650c474fdcb68ee16a540f49c1818e51f383a1f3c14ca74"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xabe33fee4a90bcb6988686fa85fe20f63e4af427a0038335b737f31055fad9b5 "))
        };
