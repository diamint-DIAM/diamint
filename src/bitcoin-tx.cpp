...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s diamint-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  diamint-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded diamint transaction") + "\n" +
              "  diamint-tx [options] -create [commands]   " + _("Create hex-encoded diamint transaction") + "\n" +
              "\n";
