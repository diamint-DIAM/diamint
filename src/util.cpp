...
const char * const BITCOIN_CONF_FILENAME = "diamint.conf";
const char * const BITCOIN_PID_FILENAME = "diamint.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Diamint";
#else
    // Unix
